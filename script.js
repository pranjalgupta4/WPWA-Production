...
let onScroll1 = function () {
  ...
  tbox1.style.top = -scrlYval * 0.3 + tbox1top + "px";
  tbox2.style.top = -scrlYval * 0.1 + tbox2top + "px";
  tbox3.style.top = -scrlYval * 0.01 + tbox3top + "px";
  tbox4.style.top = -scrlYval * 1 + tbox4top + "px";
};
